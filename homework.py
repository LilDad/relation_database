...
def task_5_delete_the_last_customer(con) -> None:
    ...
    """
    with con.cursor() as cursor:
        cursor.execute("""DELETE FROM Customers LAST""")
...
def task_8_count_customers_by_city(cur):
    ...
    """
    cur.execute("""SELECT COUNT(customerid), city FROM customers GROUP BY city ORDER BY count DESC""")
    return cur.fetchall()
...
def task_12_list_suppliers_from_specified_countries(cur):
    ...
    Returns: 8 records
    """
    cur.execute("""SELECT * FROM Customers WHERE country='USA' AND country='UK' OR country='Japan'""")
    return cur.fetchall()
...
def task_13_list_products_from_sweden_suppliers(cur):
    ...
    Returns: 3 records
    """
    cur.execute("""SELECT * FROM Suppliers WHERE country='Sweeden'""")
    return cur.fetchall()
...
def task_16_match_all_customers_and_suppliers_by_country(cur):
    ...
    Returns: 194 records
    """
    cur.execute("""SELECT customername, customers.address, customers.country 
                   AS customercountry, suppliers.country 
                   AS suppliercountry, suppliername
                   FROM customers
                   FULL JOIN suppliers
